...
/**
 * ScenariosIdEventsPostRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScenariosIdEventsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_scenarios__id__events_post_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('repeat_interval', $data ?? [], 1);
    ...
    */
     ...
     * Sets category_id
     *
     * @param int $category_id The unique identifier of the category for the event.
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param string $date The starting date of the event.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float $amount The amount of the event. A positive amount is a credit, and a negative amount is a debit.
     *
     * @return self
     */
     ...
     * Sets repeat_type
     *
     * @param string $repeat_type The repeat type of the event.
     *
     * @return self
     */
