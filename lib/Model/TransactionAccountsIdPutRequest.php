...
/**
 * TransactionAccountsIdPutRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TransactionAccountsIdPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_transaction_accounts__id__put_request';
    ...
    */
     ...
     * Sets institution_id
     *
     * @param int|null $institution_id The unique identifier of a new institution for the transaction account.
     *
     * @return self
     */
     ...
     *
     * @param float|null $starting_balance The starting balance amount of the transaction account.
     *
     * @return self
     */
     ...
     *
     * @param string|null $starting_balance_date The starting balance date of the transaction account.
     *
     * @return self
     */
