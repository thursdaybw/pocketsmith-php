...
/**
     ...
     *
     * @param  int $id The unique identifier of the user. (required)
     * @param  \OpenAPI\Client\Model\UsersIdPutRequest $users_id_put_request users_id_put_request (optional)
     ...
     */
    public function usersIdPut($id, $users_id_put_request = null, string $contentType = self::contentTypes['usersIdPut'][0])
    {
        list($response) = $this->usersIdPutWithHttpInfo($id, $users_id_put_request, $contentType);
        return $response;
    }
     ...
     *
     * @param  int $id The unique identifier of the user. (required)
     * @param  \OpenAPI\Client\Model\UsersIdPutRequest $users_id_put_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['usersIdPut'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function usersIdPutWithHttpInfo($id, $users_id_put_request = null, string $contentType = self::contentTypes['usersIdPut'][0])
    {
        $request = $this->usersIdPutRequest($id, $users_id_put_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersIdPutAsync($id, $users_id_put_request = null, string $contentType = self::contentTypes['usersIdPut'][0])
    {
        return $this->usersIdPutAsyncWithHttpInfo($id, $users_id_put_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usersIdPutAsyncWithHttpInfo($id, $users_id_put_request = null, string $contentType = self::contentTypes['usersIdPut'][0])
    {
        $returnType = '\OpenAPI\Client\Model\User';
        $request = $this->usersIdPutRequest($id, $users_id_put_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function usersIdPutRequest($id, $users_id_put_request = null, string $contentType = self::contentTypes['usersIdPut'][0])
    {
        ...
        // for model (json/xml)
        if (isset($users_id_put_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($users_id_put_request));
            } else {
                $httpBody = $users_id_put_request;
            }
