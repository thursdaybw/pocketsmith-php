...
/**
 * AccountsIdPutRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountsIdPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_accounts__id__put_request';
    ...
    */
     ...
     * Sets title
     *
     * @param string|null $title A new title for the account.
     *
     * @return self
     */
     ...
     * Sets currency_code
     *
     * @param string|null $currency_code A new currency code for the account.
     *
     * @return self
     */
     ...
     * Sets is_net_worth
     *
     * @param bool|null $is_net_worth Whether the account is a net worth account.
     *
     * @return self
     */
