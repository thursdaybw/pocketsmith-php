...
class Currency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'minor_unit' => 'int',
        'separators' => '\OpenAPI\Client\Model\CurrencySeparators',
        'symbol' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('separators', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The ISO 4217 or unofficial currency code.
     *
     * @return self
     */
     ...
     * Sets minor_unit
     *
     * @param int|null $minor_unit The number of digits after the minor unit separator.
     *
     * @return self
     */
     ...
     * Gets separators
     *
     * @return \OpenAPI\Client\Model\CurrencySeparators|null
     */
     ...
     * Sets separators
     *
     * @param \OpenAPI\Client\Model\CurrencySeparators|null $separators separators
     *
     * @return self
     */
    public function setSeparators($separators)
    {
        if (is_null($separators)) {
            throw new \InvalidArgumentException('non-nullable separators cannot be null');
        }
